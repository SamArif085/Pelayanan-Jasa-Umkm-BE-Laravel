                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" value="{{ $item['masalah'] }}"
                                            readonly />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Alamat</label>
                                        <input class="form-control form-control-lg" value="{{ $item['alamat'] }}"
                                            readonly />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">No. Telp</label>
                                        <input class="form-control form-control-lg" value="{{ $item['UserPelanggan']['no_telp']}}"
                                            readonly />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Deskripsi</label>
                                        @if(empty($item['deskripsi']))
                                        <input class="form-control form-control-lg text-danger" value="Data belum ada"
                                            readonly />
                                        @else
                                        <input class="form-control form-control-lg" value="{{ $item['deskripsi'] }}"
                                            readonly />
                                        @endif
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        @else
                                        <input class="form-control form-control-lg" value="{{ $item['harga_jasa'] }}"
                                            readonly />
                                        @endif
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" value="RP. 0" readonly />
                                        @else
                                        <input class="form-control form-control-lg" value="{{ $item['harga_alat'] }}"
                                            readonly />
                                        @endif
                                    </div>
                                    <div class="mb-3">
