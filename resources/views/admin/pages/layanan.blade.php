                    ...
                    <div class="modal fade" id="exampleModal1{{ $item['id'] }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img class="img-fluid" src="{{ asset($item['gambar']) }}" alt="" width="100%">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formUpdateLayanan" method="POST"
                                        action="{{ route('submit-layanan-web-update') }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="file" id="gambarUpdate"
                                                name="gambar" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Nama Teknisi</label>
                                            <select id="id_teknisiUpdate" name="id_teknisi" class="form-select">
                                                <option value="">Pilih Teknisi</option>
                                                @foreach ($getTeknisi as $teknisi)
                                                <option value="{{ $teknisi['id'] }}" {{ $teknisi['id']==$item['teknisi']
                                                    ? 'selected' : '' }}>
                                                    {{ $teknisi['username'] }}
                                                </option>
                                                @endforeach
